...
export function ProviderConnectionDialog({ open, onOpenChange, onSubmit, onCancel, provider, setProvider, editing, selectedProvider, saving, testing, testState, testIsCurrent, requiresTest, requiresNewKey, onTest }: { open: boolean; onOpenChange: (open: boolean) => void; onSubmit: (event: FormEvent) => void; onCancel: () => void; provider: ProviderForm; setProvider: (provider: ProviderForm) => void; editing: boolean; selectedProvider: { value: ProviderKind; label: string; defaultModel: string; description: string }; saving: boolean; testing: boolean; testState: "idle" | "passed" | "failed"; testIsCurrent: boolean; requiresTest: boolean; requiresNewKey: boolean; onTest: () => void }) {
